...
from sequence_run_manager.viewsets.sample_sheet import SampleSheetViewSet, SampleSheetBySequenceRunViewSet
...
router.register(r"sequence_run", SampleSheetBySequenceRunViewSet, basename="sequence-run-sample-sheet")
...
# api for sample sheet: get samplesheet by ss orcabus_id and verify checksum
